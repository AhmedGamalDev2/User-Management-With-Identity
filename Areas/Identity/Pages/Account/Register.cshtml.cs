...
//this is the model (Model Behind)
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    UserName = new MailAddress(Input.Email).User,//new 
                    Email = Input.Email,
                ...
                if (result.Succeeded)
                {
                    ...
                    await _userManager.AddToRoleAsync(user, "User");//for add User to a specified Role
